...
public class BFSPatterns {
    ...
    /** Level Order Traversal. Queue processes one level at a time. */
    ...
    /** Minimum Depth of Binary Tree. First leaf found = minimum depth. */
    ...
    /** N-ary Tree Level Order. Same as binary but iterate children. */
    /** Cousins in Binary Tree. Same depth, different parent. */
    ...
    /** Univalued Binary Tree. BFS checking all values equal. */
    ...
    /** Maximum Depth via BFS. Count number of levels. */
    ...
    /** Find if Path Exists in Graph. BFS from source to destination. */
    ...
    /** Symmetric Tree via BFS. Level-order mirror comparison. */
    ...
    /** Nearest Exit from Entrance in Maze. BFS from entrance to border cell. */
    ...
    /** Rotting Oranges. Multi-source BFS from all rotten. */
    ...
    /** Word Ladder. BFS on word graph (1 char diff). */
    ...
    /** 01 Matrix (distance to nearest 0). Multi-source BFS from all zeros. */
    ...
    /** Open the Lock. BFS on 4-digit state space. */
    ...
    /** Number of Islands BFS. BFS flood-fill from each '1'. */
    ...
    /** Shortest Bridge. Find island, BFS expand to second. */
    ...
    /** Cheapest Flights Within K Stops. BFS/Bellman-Ford with hop limit. */
    ...
    /** Snakes and Ladders. BFS on board with jumps. */
    ...
    /** Minimum Genetic Mutation. BFS on gene string graph. */
    ...
    /** Cut Off Trees for Golf Event. BFS between consecutive trees. */
