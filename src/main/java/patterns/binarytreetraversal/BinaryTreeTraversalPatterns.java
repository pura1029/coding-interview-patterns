...
public class BinaryTreeTraversalPatterns {
    ...
    /** Symmetric Tree. Mirror comparison of left/right. */
    ...
    /** Path Sum. Subtract node value, check leaf. */
    ...
    /** Count Complete Tree Nodes. Binary search on last level. */
    ...
    /** Binary Tree Right Side View. Last node at each BFS level. */
    ...
    /** Lowest Common Ancestor. Recurse: if both sides return, curr is LCA. */
    ...
    /** Flatten Binary Tree to Linked List. Preorder rewiring of next pointers. */
    ...
    /** Construct Binary Tree from Preorder and Inorder. Root from preorder, split by inorder. */
    ...
    /** Diameter of Binary Tree. Max (leftDepth + rightDepth) at any node. */
    ...
    /** All Paths from Root to Leaf. DFS collecting path strings. */
    ...
    /** Vertical Order Traversal. Column index + BFS/DFS grouping. */
    ...
    /** Binary Tree Cameras. Greedy post-order: cover parent. */
    ...
    /** Recover Binary Search Tree. Find two swapped nodes in inorder. */
    ...
    /** Count Good Nodes in Binary Tree. Track max from root to current. */
    ...
    /** Binary Tree to Doubly Linked List. Inorder threading of nodes. */
    ...
    /** Sum of Distances in Tree. Re-root DP: parent + child contributions. */
    ...
    /** Longest Path With Different Adjacent Characters. DFS tracking max two child paths. */
    ...
    /** Maximum Width of Binary Tree. Level-order with position indexing. */
