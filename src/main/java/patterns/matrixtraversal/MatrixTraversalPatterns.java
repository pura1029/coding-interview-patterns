...
public class MatrixTraversalPatterns {
    ...
    /** Island Perimeter. Count edges adjacent to water. */
    ...
    /** Reshape Matrix. Linear index mapping. */
    ...
    /** Cells in Range on Excel Sheet. Iterate column and row ranges. */
    ...
    /** Count Negative Numbers. Linear scan or staircase search. */
    public static int countNegatives(int[][] grid) { int c=0; for(int[] r:grid) for(int v:r) if(v<0) c++; return c; }
    /** Toeplitz Matrix. Each cell equals top-left diagonal. */
    ...
    /** Lucky Numbers in a Matrix. Row min that is also column max. */
    ...
    /** Matrix Diagonal Sum. Primary + secondary diagonals. */
    ...
    /** Richest Customer Wealth. Max row sum. */
    ...
    /** Spiral Matrix. Shrink boundaries after each pass. */
    ...
    /** Game of Life. Encode state transitions in-place. */
    ...
    /** Max Area of Island. DFS counting connected cells. */
    ...
    /** Surrounded Regions. DFS from borders, flip remaining. */
    ...
    /** Where Will the Ball Fall. Simulate ball path per column. */
    ...
    /** Diagonal Traverse. Alternate direction per diagonal. */
    ...
    /** Spiral Matrix II (generate). Fill with shrinking boundaries. */
