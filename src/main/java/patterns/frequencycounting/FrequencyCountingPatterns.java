...
public class FrequencyCountingPatterns {
     ...
     * Valid Anagram
     *
     * <p><b>Approach:</b> Valid Anagram. Compare character frequency arrays.
     *
     ...
     *
     * <p><b>Approach:</b> First Unique Character in a String. Count frequencies, find first with count 1.
     *
     * @param s the s parameter
     * @return the computed result
     */
     ...
     * Contains Duplicate
     *
     * <p><b>Approach:</b> Contains Duplicate. HashSet membership check.
     *
     ...
     * Majority Element
     *
     * <p><b>Approach:</b> Majority Element. Cancel different elements.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     * Ransom Note
     *
     * <p><b>Approach:</b> Ransom Note. Magazine must have enough of each char.
     *
     ...
     * Find the Difference
     *
     * <p><b>Approach:</b> Find the Difference. XOR all characters.
     *
     * @param s the s parameter
     * @param t the t parameter
     * @return the computed result
     ...
     * Jewels and Stones
     *
     * <p><b>Approach:</b> Jewels and Stones. HashSet of jewels, count matches.
     *
     * @param jewels the jewels parameter
     * @param stones the stones parameter
     * @return the computed result
     */
     ...
     * Word Pattern
     *
     * <p><b>Approach:</b> Word Pattern. Bijection between words and chars.
     *
     ...
     * Isomorphic Strings
     *
     * <p><b>Approach:</b> Isomorphic Strings. Two-way character mapping.
     *
     * @param s the s parameter
     * @param t the t parameter
     * @return the computed result
     ...
     * Missing Number
     *
     * <p><b>Approach:</b> Missing Number. XOR with indices or sum formula.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     * Group Anagrams
     *
     * <p><b>Approach:</b> Group Anagrams. Sort each word as key.
     *
     ...
     *
     * <p><b>Approach:</b> Top K Frequent Elements. Bucket sort by frequency.
     *
     * @param nums the nums parameter
     ...
     *
     * <p><b>Approach:</b> Longest Consecutive Sequence. HashSet + expand from smallest.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Sort Characters By Frequency. Count + sort by frequency.
     *
     * @param s the s parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Find All Duplicates in an Array. Mark visited by negating.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     * Custom Sort String
     *
     * <p><b>Approach:</b> Custom Sort String. Sort by order index map.
     *
     ...
     * Encode TinyURL
     *
     * <p><b>Approach:</b> Generate a sequential short key, store the mapping from short URL to long URL in a HashMap.
     *
     ...
     * Decode TinyURL
     *
     * <p><b>Approach:</b> Look up the short URL in the HashMap to retrieve the original long URL.
     *
     ...
     *
     * <p><b>Approach:</b> Subarray Sum Equals K. Prefix sum + frequency map.
     *
     * @param nums the nums parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Minimum Number of Steps to Make Two Strings Anagram. Count character difference.
     *
     * @param s the s parameter
     * @param t the t parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Determine if Two Strings Are Close. Same char set + same sorted frequencies.
     *
     * @param w1 the w1 parameter
     * @param w2 the w2 parameter
     * @return the computed result
     */
    ...
    /**
     * Min Window Containing Pattern
     *
     * <p><b>Approach:</b> Min Window Containing Pattern. Sliding window with need/have counts.
     *
     * @param s the s parameter
     * @param t the t parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Longest Substring with At Most K Distinct Characters. Shrink when distinct > k.
     *
     * @param s the s parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> First Missing Positive. Cyclic sort to place i at index i-1.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Majority Element II (elements appearing > n/3 times). Boyer-Moore with two candidates.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Substring with Concatenation of All Words. Word-level sliding window.
     *
     * @param s the s parameter
     ...
     *
     * <p><b>Approach:</b> Count of Smaller Numbers After Self. Merge sort with index tracking.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
    ...
    /**
     * Smallest Sufficient Team (bitmask)
     *
     * <p><b>Approach:</b> Smallest Sufficient Team (bitmask). Bitmask DP on skill coverage.
     *
     * @param reqSkills the reqSkills parameter
    ...
    /**
     * All O`one Data Structure (increment/decrement/getMaxKey/getMinKey)
     *
     * <p><b>Approach:</b> All O`one Data Structure (increment/decrement/getMaxKey/getMinKey)
     */
    static class AllOne {
     ...
     *
     * <p><b>Approach:</b> Rearrange String K Distance Apart. Greedy with max-heap + cooldown.
     *
     * @param s the s parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Max Points on a Line. Slope frequency per point.
     *
