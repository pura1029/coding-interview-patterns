...
public class FrequencyCountingPatterns {
    ...
    // EASY 2: First Unique Character in a String
    ...
    // MEDIUM 4: Sort Characters By Frequency
    ...
    // MEDIUM 5: Find All Duplicates in an Array
    ...
    // MEDIUM 7: Encode and Decode TinyURL
    ...
    // MEDIUM 8: Subarray Sum Equals K
    ...
    // MEDIUM 9: Minimum Number of Steps to Make Two Strings Anagram
    ...
    // MEDIUM 10: Determine if Two Strings Are Close
    ...
    // HARD 1: Min Window Containing Pattern
    ...
    // HARD 4: Majority Element II (elements appearing > n/3 times)
    ...
    // HARD 5: Substring with Concatenation of All Words
    ...
    // HARD 6: Count of Smaller Numbers After Self
    ...
    // HARD 7: Smallest Sufficient Team (bitmask)
    ...
    // HARD 8: All O`one Data Structure (increment/decrement/getMaxKey/getMinKey)
    static class AllOne {
    ...
    // HARD 9: Rearrange String K Distance Apart
