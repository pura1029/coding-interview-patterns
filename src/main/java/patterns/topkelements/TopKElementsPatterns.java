...
public class TopKElementsPatterns {
     ...
     * Kth Largest Element
     *
     * <p><b>Approach:</b> Kth Largest Element. Min-heap of size k.
     *
     ...
     * Last Stone Weight
     *
     * <p><b>Approach:</b> Last Stone Weight. Max-heap, smash two largest.
     *
     ...
     *
     * <p><b>Approach:</b> Kth Largest Element in Stream. Maintain min-heap of size k.
     */
     ...
     *
     * <p><b>Approach:</b> Sort Array By Increasing Frequency. Count + custom sort.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     * Relative Ranks
     *
     * <p><b>Approach:</b> Relative Ranks. Sort by score, assign ranks.
     *
    ...
    /**
     * K Closest Points to Origin (simplified: sort)
     *
     * <p><b>Approach:</b> K Closest Points to Origin (simplified: sort). Min-heap by distance.
     *
    ...
    /**
     * Find K Pairs with Smallest Sums (simplified)
     *
     * <p><b>Approach:</b> Find K Pairs with Smallest Sums (simplified). Min-heap of pair sums.
     *
     ...
     *
     * <p><b>Approach:</b> Maximum Product of Two Elements. Find two largest values.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
    ...
    /**
     * Find K Largest in Array (using sort)
     *
     * <p><b>Approach:</b> Find K Largest in Array (using sort). Sort descending, take first k.
     *
     * @param nums the nums parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Minimum Cost of Buying Candies With Discount. Sort, skip every 3rd.
     *
     ...
     * Reorganize String
     *
     * <p><b>Approach:</b> Reorganize String. Greedy with max-heap.
     *
     * @param s the s parameter
     * @return the computed result
     */
     ...
     * Task Scheduler
     *
     * <p><b>Approach:</b> Task Scheduler. Max-freq determines idle slots.
     *
     ...
     *
     * <p><b>Approach:</b> Kth Smallest Element in a Sorted Matrix. Min-heap or binary search.
     *
     ...
     *
     * <p><b>Approach:</b> Top K Frequent Words. Min-heap with custom comparator.
     *
     ...
     *
     * <p><b>Approach:</b> Least Number of Unique Integers after K Removals. Remove least frequent first.
     *
     ...
     *
     * <p><b>Approach:</b> Find K-th Smallest Pair Distance. Binary search on distance.
     *
     * @param nums the nums parameter
     * @param k the k parameter
     * @return the computed result
     ...
     * Ugly Number II
     *
     * <p><b>Approach:</b> Ugly Number II. Min-heap of multiples of 2,3,5.
     *
     * @param n the n parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Seat Reservation Manager. Min-heap of available seats.
     */
     ...
     *
     * <p><b>Approach:</b> Find Median from Data Stream. Two heaps: max-heap + min-heap.
     */
     ...
     *
     * <p><b>Approach:</b> Min-heap approach: add all list heads to a priority queue; repeatedly poll the smallest, append to result, and push its next node.
     *
     ...
     *
     * <p><b>Approach:</b> Sliding Window Median. Two sorted sets with lazy deletion.
     *
     * @param nums the nums parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> IPO (maximize capital). Max-heap profits, min-heap capitals.
     *
     * @param k the k parameter
     ...
     *
     * <p><b>Approach:</b> Smallest Range Covering Elements from K Lists. Min-heap + track global max.
     *
     * @param nums the nums parameter
     * @return the computed result
     */
     ...
     *
     * <p><b>Approach:</b> Trapping Rain Water II (3D). BFS from border with min-heap.
     *
     ...
     *
     * <p><b>Approach:</b> Maximum Frequency Stack. Stack per frequency level.
     */
    ...
    /**
     * Course Schedule III (max courses by deadline)
     *
     * <p><b>Approach:</b> Course Schedule III (max courses by deadline). Greedy sort by deadline + max-heap.
     *
     ...
     *
     * <p><b>Approach:</b> K Closest Points (Quick Select). Partition around kth distance.
     *
     * @param points the points parameter
     * @param k the k parameter
     * @return the computed result
     ...
     *
     * <p><b>Approach:</b> Minimum Cost to Hire K Workers. Sort by rate, max-heap for quality.
     *
