...
public class BitManipulationPatterns {
    ...
    // EASY 10: Check if Number is Sum of Powers of Three
    ...
    // MEDIUM 3: Letter Case Permutation
    ...
    // MEDIUM 7: Sum of Two Integers (no + operator)
    public static int getSum(int a, int b) { while (b != 0) { int carry = (a & b) << 1; a ^= b; b = carry; } return a; }
    // MEDIUM 8: Maximum XOR of Two Numbers in Array
    ...
    // HARD 1: Single Number III (two uniques)
    ...
    // HARD 4: Maximum Product of Word Lengths (bitmask words)
    ...
    // HARD 5: Count Triplets That Can Form Two Arrays of Equal XOR
    ...
    // HARD 6: Find XOR Sum of All Pairs Bitwise AND
    ...
    // HARD 7: Concatenation of Consecutive Binary Numbers
    ...
    // HARD 8: Divide Two Integers (bit shifting)
    ...
    // HARD 9: Maximum AND Sum of Array (bitmask DP)
    ...
    // HARD 10: Shortest Subarray with OR at Least K II
