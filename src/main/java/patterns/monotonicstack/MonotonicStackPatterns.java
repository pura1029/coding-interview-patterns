...
public class MonotonicStackPatterns {
    ...
    /** Daily Temperatures. Stack of indices, pop when warmer found. */
    ...
    /** Next Greater Element I. Map next-greater via stack. */
    ...
    /** Final Prices With Special Discount. Next smaller element = discount. */
    ...
    /** Remove Outermost Parentheses. Track depth, skip outer layer. */
    ...
    /** Make The String Great (remove adjacent pairs of same letter different case). Stack removes adjacent case-pair. */
    ...
    /** Remove All Adjacent Duplicates In String. Stack pops matching top. */
    ...
    /** Backspace String Compare. Stack simulates backspace. */
    ...
    /** Valid Parentheses. Stack matches open/close brackets. */
    ...
    /** Min Stack. Auxiliary stack tracks running min. */
    ...
    /** Next Greater Element II (Circular). Double traversal with modulo. */
    ...
    /** Online Stock Span. Stack of (price, span) pairs. */
    ...
    /** Remove K Digits. Maintain increasing stack, remove k. */
    ...
    /** 132 Pattern. Reverse scan with max "2" tracking. */
    ...
    /** Remove Duplicate Letters (smallest lexicographic subsequence). Greedy stack + last-occurrence check. */
    ...
    /** Asteroid Collision. Stack simulates collisions. */
    ...
    /** Sum of Subarray Minimums. Contribution of each min via boundaries. */
    ...
    /** Decode String. Stack of (string, count) pairs. */
    ...
    /** Car Fleet. Sort by position, stack by arrival time. */
    ...
    /** Largest Rectangle in Histogram. Stack finds left/right boundaries. */
    ...
    /** Maximal Rectangle. Row-wise histogram + largest rectangle. */
    ...
    /** Trapping Rain Water (using stack). Stack tracks valleys between bars. */
    ...
    /** Sum of Subarray Ranges (max - min for all subarrays). Max-min contribution for all subarrays. */
    ...
    /** Number of Visible People in a Queue. Decreasing stack from right. */
    ...
    /** Maximum Width Ramp (largest j-i where nums[i] <= nums[j]). Decreasing stack + right scan. */
    ...
    /** Steps to Make Array Non-decreasing. Track rounds via stack simulation. */
    ...
    /** Longest Valid Parentheses. Stack of indices for valid segments. */
    ...
    /** Create Maximum Number (merge two arrays to form largest k digits). Merge two max subsequences. */
    ...
    /** Minimum Cost Tree From Leaf Values. Greedy: remove smallest leaf first. */
