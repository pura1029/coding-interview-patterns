...
public class BacktrackingPatterns {
    ...
    // EASY 1: Generate Parentheses (simplified n=1,2)
    // EASY 2: Letter Combinations of a Phone Number (single digit)
    // EASY 3: Binary Watch
    ...
    // EASY 5: Permutations of unique array
    ...
    // EASY 7: Combination Sum (use each unlimited times)
    ...
    // EASY 9: Count Number of Maximum Bitwise-OR Subsets
    ...
    // EASY 10: Check if Puzzle is Solvable (simple case)
    ...
    // MEDIUM 4: Subsets II (with duplicates)
    ...
    // MEDIUM 5: Combination Sum II (each used once)
    ...
    // MEDIUM 6: Permutations II (with duplicates)
    ...
    // MEDIUM 7: Palindrome Partitioning
    ...
    // MEDIUM 9: Beautiful Arrangement
    ...
    // HARD 3: Word Search II
    // HARD 4: Expression Add Operators
